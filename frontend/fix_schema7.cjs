...
const correctAlert = `        <va-alert color="info" dense class="w-full" style="font-size: 0.85rem;">
...
// Lines 395 to 412 should be replaced!
lines.splice(395, 18, ...correctAlert.split('\n'));
